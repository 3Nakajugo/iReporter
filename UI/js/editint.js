function edit(incident_id) {
    ...
    let location_url = `http://127.0.0.1:5000/api/v2/interventions/${incident_id}/location`;
    let comment_url = `http://127.0.0.1:5000/api/v2/interventions/${incident_id}/comment`;
